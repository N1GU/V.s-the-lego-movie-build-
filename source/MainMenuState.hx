...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		add(bgborder);
		FlxTween.tween(bgborder, {x: bgborder.x - 1000}, 1.04, {ease: FlxEase.quadInOut});
			...
			{
				{
					...
					//FlxTween.tween(charadd, {x: -2000}, 2.2, {ease: FlxEase.expoInOut});

					//FlxTween.tween(bg, {y:-1500}, 1.2, {ease: FlxEase.expoIn});

					FlxTween.tween(bgborder, {y:1500}, 1.5, {ease: FlxEase.expoIn});
